...
class EditProfileValidationScreen extends StatelessWidget {
  const EditProfileValidationScreen({super.key});
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              CustomText(
                text:
                    "We have sent you an OTP code to your current email address. Enter the OTP code to change the mobile/email address.",
                fontSize: 16.sp,
                maxLines: 3,
