  ...
  final List<Map<String, String>> data = [
    {
      ...
      "title": "Salon Salon Salon Salon Salon"
    },
    {
      "image": AppImages.banner,
      "title": "Salon"
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              CustomText(text: "Hello, Smith",fontSize: 24,fontWeight: FontWeight.w600,color: AppColors.purple_100,bottom: 8.h),
              CustomText(text: "Welcome to BarBar",color: AppColors.purple_100,bottom: 16.h),
